...
- **`runner.py`**: Reproducible wrappers around Snakemake and scorer execution. It calls `../postprocess/Snakefile` explicitly and can build missing BAM indexes before a real run.
