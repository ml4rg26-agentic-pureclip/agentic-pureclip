...
Usage:
    python scripts/list_motifs.py                    # list all databases and RBPs
    python scripts/list_motifs.py --rbp RBFOX2        # show motifs for a specific RBP
    python scripts/list_motifs.py --db mCrossBase     # show all RBPs in a database
    python scripts/list_motifs.py --rbp RBFOX2 --cell K562  # cell-line specific
"""
