...
Second, prior and no-prior LLM performance was broadly comparable. The mean
difference gave the prior a slight edge of 0.004, but the median was $-0.002$:
two datasets favored the prior, three favored no prior, and one was tied. The
larger positive HNRNPK difference accounts for the small mean advantage, whereas
the remaining differences were modest and mixed. This is consistent with a
dataset-specific effect rather than a systematic benefit of biological context.
For U2AF2, sequence motifs are also an incomplete description of binding because
position relative to splice sites is central. With one trajectory per condition,
protein-class effects cannot be separated from dataset idiosyncrasies or
